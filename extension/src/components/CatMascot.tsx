...
export default function CatMascot({
  ...
  return (
    <div style={{ position: "relative", display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <svg viewBox="335 175 330 310" style={{ width: 72, height: 72 }}>
        <g className="cat-breathe" style={{ transformOrigin: "460px 430px" }}>
          ...
          <g style={{ transformOrigin: "460px 360px" }}>
            ...
            <g
              ...
              strokeLinecap="round"
              fill="none"
              style={{ opacity: browsVisible ? 1 : 0, transition: "opacity 0.2s" }}
            >
              <path d="M400 293 L426 301" />
              <path d="M494 301 L520 293" />
            </g>

            <g style={{ opacity: eyesOpen ? 0 : 1, transition: "opacity 0.2s" }}>
